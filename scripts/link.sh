...
echo "[1/8] Linking shell configs..."
...
echo "[2/8] Linking editor configs..."
...
echo "[5/8] Linking Claude Code configs..."
mkdir -p "$HOME/.claude"
...
echo "[6/8] Copying KDE configs (no symlinks - KDE overwrites them)..."
