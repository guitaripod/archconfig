...
echo "[1/10] Linking shell configs..."
...
echo "[2/10] Linking editor configs..."
...
echo "[5/10] Linking Claude Code configs..."
mkdir -p "$HOME/.claude"
...
echo "[6/10] Copying KDE configs (no symlinks - KDE overwrites them)..."
